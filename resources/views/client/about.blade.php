    ...
    <div class="container mw-lg-100 p-lg-0">
        <div class="row m-0">
                    ...
                    <div class="row mb--50">
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/01.png" alt="overview">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/02.png" alt="overview">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/03.png" alt="overview">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/04.png" alt="overview">
                                </div>
                                <div class="content">
                                    <h6 class="title">Supports Multiple Currency</h6>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/05.png" alt="overview">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-sm-6">
                            <div class="expert-item">
                                <div class="thumb">
                                    <img src="  images/overview/06.png" alt="overview">
                                </div>
                                <div class="content">
            ...
            <div class="col-lg-6 pl-30 pr-0">
                <div class="w-100 h-100 bg_img" data-background="  images/overview/overview-bg.png"></div>
            </div>
        </div>
    </div>
</section>
