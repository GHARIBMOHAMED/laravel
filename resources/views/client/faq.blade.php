            ...
            <div class="row mb--50">
                <div class="col-lg-8 mb-50">
                    <div class="faq-wrapper">
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">How to leave an absentee bid</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">How do I know if I won an item?</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">How do I know if I'm the high bidder?</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">Can I bid using my mobile device?</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">Where do I access my saved items?</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                        ...
                        <div class="faq-item">
                            <div class="faq-title">
                                <img src="{{ asset('css/img/faq.png')}}" alt="css"><span class="title">Cancellations and returns</span><span class="right-icon"></span>
                            </div>
                            <div class="faq-content">
                                <p>All successful bidders can confirm their winning bid by checking the “Sbidu”. In addition, all successful bidders will receive an email notifying them of their winning bid after the auction closes.</p>
                            </div>
                ...
                <div class="col-lg-4 mb-50">
                    <aside class="sticky-menu">
                        <div class="faq-menu bg_img mb-30" data-background="./{{ asset('images/faq/faq-menu.png')}}" style="background-image: url(_/{{ asset('images/faq/faq-menu.html')}}">
                            <ul id="faq-menu">
                                <li class="nav-item">
