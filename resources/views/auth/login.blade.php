                ...
                <form class="form"  method="POST" action="{{ route('login') }}" >
                    @csrf
                     ...
                     <div class="form-group">
                         ...
                         <input class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 @error('email') is-invalid @enderror white" type="email" id="email" placeholder="Email"  name="email" value="{{ old('email') }}" required autocomplete="email" autofocus/>
                         @error('email')
                     ...
                     <div class="pb-lg-0 pb-5">
                         ...
                         <a type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg" href="{{ url('login/google/') }}">
